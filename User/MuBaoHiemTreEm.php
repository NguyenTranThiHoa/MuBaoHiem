...
<body style="background-color:white;">
  <header>
    ...
    <div class="row">
      <div class="head">
        <div class="logo">
          <img src="images/anh1.png" alt="Logo" width="115px" height="100px">
          <h2 style="color: black; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">RoyalHelmet
          </h2>
        </div>
      </div>
      ...
      <?php
          ...
          $dataProduct = $db->showlist($tblTableProduct);
            foreach ($dataProduct as $dtProduct) {
              echo '<a href="#">' . $dtProduct['phanloai_name'] . '</a>';
              }
        ?>
      </div>
    </div>
    ...
    <div class="footer-content">
      <div class="tieude">
        <ul>
          ...
          <li style="color: white;"><i class="fas fa-map-marker-alt"></i>Địa Chỉ: 466 đường Bưởi, P. Vĩnh Phúc, Q. Ba
            Đình, Hà Nội</li>
          ...
          <li style="color: white;"><i class="fas fa-map-marker-alt"></i>Địa Chỉ: 147 Đồng Đen, Phường 11, Quận Tân Bình
          </li>
          ...
          <li style="color: white;"><i class="fas fa-map-marker-alt"></i>Địa Chỉ: 8/304,Manisha Nagar, Mumbai Pune Road,
