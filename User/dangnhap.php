...
<!------------------------------------------------------------------------> 
<article>
<!------------------------------DÙNG ĐĂNG NHẬP CHO PHP---------------------------->
    <form action="xulydangnhap.php" method="post" autocomplete="off">
    <div class="dangnhap1">
        <h3>ĐĂNG NHẬP</h3>
<!------------------------------------------------------------------------> 
...
<!------------------------------------------------------------------------> 
        ...
        <input type="text" placeholder="Email hoặc điện thoại" id="username" name="username"> 
        ...
        <h4>
            ...
            <a href="dangki.php" style="color: blue">Đăng ký tại đây</a>
        </h4>
        <button class="submit-button" type="submit" name="login">Đăng nhập</button>
